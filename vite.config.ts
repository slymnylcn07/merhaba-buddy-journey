    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'guide-data': [
            path.resolve(__dirname, './src/data/guides.ts'),
            path.resolve(__dirname, './src/data/recent-guides-data.ts'),
            path.resolve(__dirname, './src/data/article-ctas.ts'),
            path.resolve(__dirname, './src/data/recent-article-ctas.ts'),
            path.resolve(__dirname, './src/data/article-howto-schemas.ts'),
            path.resolve(__dirname, './src/data/article-editorial-crosslinks.tsx'),
            path.resolve(__dirname, './src/data/article-source-standards.ts'),
            path.resolve(__dirname, './src/data/related-guides.ts'),
          ],
        },
      },
    },
