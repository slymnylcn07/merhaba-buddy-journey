...
const articleContent = (
  <>
    ...
    <InfoBox title="Concentric vs Eccentric Loading">
      ...
      <p className="mt-2"><strong>Going down (eccentric):</strong> Your quadriceps lengthen while resisting gravity — essentially acting as a brake. This eccentric loading generates higher peak forces within the muscle-tendon unit and concentrates pressure on the kneecap.</p>
    </InfoBox>
    ...
    <p>
      For those who find even gentle stair descent uncomfortable, consider descending sideways while holding the handrail. This technique reduces the knee bend angle and shifts some of the load to the hip muscles instead of concentrating it on the kneecap. If your discomfort extends beyond stairs to <Link to="/guides/For those who find even gentle stair descent uncomfortable, consider descending sideways while holding the handrail. This technique reduces the knee bend angle and shifts some of the load to the hip muscles instead of concentrating it on the kneecap. If your discomfort extends beyond stairs to <Link to="/guides/knee-pain-when-kneeling" className="text-primary hover:underline">knee pain when bending</Link> in general, the underlying cause may require broader attention." className="text-primary hover:underline">knee pain when bending</Link> in general, the underlying cause may require broader attention.
    </p>
...
export const kneePainGoingDownStairs: ArticleExport = {
  article: {
    ...
    intro: "Knee pain when going down stairs is one of the most common knee complaints — and there's a clear biomechanical reason why descending hurts more than climbing. This guide explains the science, common causes, and daily habits that may support knee comfort.",
