  ...
  article: {
    ...
    content: (
      <>
        ...
        <p>For ingredient-specific evidence, formulations, and dosing considerations, read the separate guides to <Link to="/guides/glucosamine-chondroitin-knee-pain">glucosamine and chondroitin</Link>, <Link to="/guides/turmeric-curcumin-knee-pain">turmeric and curcumin</Link>, and <Link to="/guides/collagen-peptides-knee-pain">collagen peptides</Link>.</p>
