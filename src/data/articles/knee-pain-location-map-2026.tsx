    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>Ice after acute intense sessions, <Link to="/guides/heat-vs-ice-for-knees" className="text-primary underline hover:opacity-80">warmth for chronic stiffness</Link></li>
        ...
        <p>
          Many people interpret knee discomfort differently depending on where it appears. A dull ache in the front of the knee might feel like general tiredness, while a sharp sensation on the outer side can feel more alarming. Understanding these differences helps you respond with the right comfort strategy rather than guessing. People who experience <Link to="/guides/why-do-my-knees-feel-tight-after-resting" className="text-primary underline hover:opacity-80">stiffness after resting</Link> often notice it most in the back of the knee, while those with <Link to="/guides/knee-pain-climbing-stairs" className="text-primary underline hover:opacity-80">stair-related discomfort</Link> typically feel it at the front.
        </p>
