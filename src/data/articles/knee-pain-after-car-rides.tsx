  ...
  article: {
    ...
    content: (
      <>
        ...
        <p>
          The muscles surrounding the knee, including the quadriceps, hamstrings, and calf muscles, become essentially dormant during prolonged sitting. Without regular contractions, these muscles lose their readiness for immediate activity. When you stand after a long drive, the muscles need time to "wake up" and regain their full function, which contributes to the sensation of weakness or unsteadiness. For more on this pattern, see our guide on <Link to="/guides/knees-hurt-after-resting" className="text-primary hover:underline">knee stiffness after resting</Link>., including the quadriceps, hamstrings, and calf muscles, become essentially dormant during prolonged sitting. Without regular contractions, these muscles lose their readiness for immediate activity. When you stand after a long drive, the muscles need time to "wake up" and regain their full function, which contributes to the sensation of weakness or unsteadiness. For more on this pattern, see our guide on <Link to="/guides/knees-hurt-after-resting" className="text-primary hover:underline">knee stiffness after resting</Link>." className="text-primary hover:underline">knee stiffness after resting</Link>.
        </p>
