  ...
  article: {
    ...
    content: (
      <>
        ...
        <p>Different symptoms and device types need different considerations. Read <Link to="/guides/knee-pain-after-flights">knee pain after flights</Link> for travel-related patterns and <Link to="/guides/do-knee-massagers-work">do knee massagers work</Link> for devices that act directly around the knee.</p>
