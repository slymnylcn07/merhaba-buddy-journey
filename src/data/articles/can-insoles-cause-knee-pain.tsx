...
export const canInsolesCauseKneePain: ArticleExport = {
  ...
  },
  {
    ...
    content: (<>
        ...
        <p>If your next footwear change is a pair for home, compare the fit and fastening options in our <Link to="/guides/best-slippers-knee-pain">slippers for knee pain guide</Link> before assuming the same insert will suit them.</p>
