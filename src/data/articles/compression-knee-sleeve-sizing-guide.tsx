...
export const compressionKneeSleeveSizingGuide: ArticleExport = {
  ...
  article: {
    ...
    faqs: [
      ...
      { question: "How do I know what size knee sleeve to get?", answer: "Measure the circumference of your leg above the knee, at the height the brand's chart specifies (typically 10-15 cm / 4-6 in above the kneecap), with the leg straight and relaxed, then match that number to the size chart. If you are between sizes, choose based on purpose: size down for sport and maximum support, size up for all-day comfort and sensitive skin." },
