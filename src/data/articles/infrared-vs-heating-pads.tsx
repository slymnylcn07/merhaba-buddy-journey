...
export const infraredVsHeatingPads: ArticleExport = {
  ...
  article: {
    ...
    faqs: [
      ...
      { question: "Can I use a heating pad on my knee every day?", answer: "Most people can use a heating pad daily for 15-20 minutes at a time. However, heating pads lack auto-shutoff features and ergonomic knee-specific designs that infrared devices often include." },
      ...
      { question: "How long should I use an infrared knee massager?", answer: "A typical session lasts 15-20 minutes. Many devices have built-in timers to help you stay consistent without overdoing it." },
    ...
    content: (
      <>
        ...
        <h2>How Heating Pads Deliver Warmth</h2>
        <p>
          Traditional heating pads work by generating surface-level warmth through electric coils or gel packs. They're affordable, widely available, and simple to use. For general muscle stiffness in flat body areas like the back or shoulders, they can be quite effective.
        </p>
        <p>
