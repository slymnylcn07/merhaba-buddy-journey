...
export const guidesData: GuideData[] = [
  ...
  },
  {
    ...
    description: "Compare pain behind the knee when bending, straightening, after sitting, or after exercise, including Baker's cyst and urgent calf warning signs.",
    readTime: 13,
  ...
  },
  {
    ...
    description: "Compare glucosamine, turmeric, collagen, omega-3, vitamin D, and magnesium by evidence limits, safety checks, and knee condition.",
    readTime: 13,
    lastModified: "2026-08-29",
  },
  {
  ...
  },
  {
    ...
    description: "Modify lotus, pigeon, child's pose, hero pose, kneeling, and standing yoga while recognizing back-of-knee symptoms and warning signs.",
    readTime: 14,
    lastModified: "2026-08-29",
  },
  {
    ...
    description: "Compare uphill, downhill, uneven-ground, and after-hike knee pain using terrain, pack weight, poles, location, and workload clues.",
    readTime: 14,
    lastModified: "2026-08-29",
  },
  {
  ...
  },
  {
    ...
    description: "Separate right-knee pedal pain from bent-knee stiffness after a car ride using seat setup, symptom location, and travel warning signs.",
    readTime: 12,
    lastModified: "2026-08-29",
  },
  {
  ...
  },
  {
    ...
    description: "Compare compression boots, calf wraps, soreness, performance, swelling, heat, pressure settings, and contraindications without recovery hype.",
    readTime: 13,
    lastModified: "2026-08-29",
  },
  {
