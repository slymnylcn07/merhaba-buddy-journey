        ...
        <section className="py-12 md:py-20 border-b border-border/30">
          <div className="container px-4 max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground font-light leading-relaxed max-w-2xl mx-auto">
              Explore easy-to-understand guides about knee discomfort, at-home support options, and everyday comfort — designed to help you make informed decisions.
            </p>
          </div>
        </section>
          ...
          <div className="container px-4 max-w-4xl mx-auto">
            <div className="grid gap-6 md:gap-8">
              {guides.map((guide) => (
                ...
                >
                  <article className="bg-background border border-border/50 rounded-2xl p-6 md:p-8 shadow-sm hover:shadow-md hover:border-border transition-all duration-300">
